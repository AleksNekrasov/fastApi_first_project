...
Revision ID: f0f0a2b7ab7c
Revises: 
Create Date: 2024-11-02 13:50:50.258370
...
def upgrade() -> None:
    ...
    sa.Column('gender', sa.Enum('MALE', 'FEMALE', name='genderenum', create_type=False), nullable=False), # добавил create_type=False
    ...
    sa.Column('photos_url', postgresql.ARRAY(sa.String()), nullable=True),
